                            ...
                            <fieldset>
                                ...
                                <FormGroup label='Url ' htmlFor="url">
                                    <input type='text'
                                        ...
                                        name="url"
                                        id="url"
                                        aria-describedby="urlHelp" placeholder="Ex: google.com"
                                        onChange={e => this.setState({ url: e.target.value })} />

                                </FormGroup>

                                <FormGroup label='Data de acesso ' htmlFor="dataAcesso">
                                    <input type='text'
                                        name="dataAcesso"
                                        className="form-control"
                                        id="dataAcesso"
                                        aria-describedby="dataAcessoHelp" placeholder="Ex: 08/06/2016"
                                        onChange={e => this.setState({ dataAcesso: e.target.value })} />
