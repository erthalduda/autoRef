                    ...
                    <div className="col-md-6" style={{ position: 'relative', left: '300px' }}>
                        <div className="jumbotron">
                            ...
                            <div className="button1">
                                ...
                                <button onClick={this.prepareParteMonografia} className="btn btn-success">Parte de monografia</button>
                                <button onClick={this.prepareMonografiaOnline} className="btn btn-success">Monografia Online</button>
                                <button onClick={this.prepareMonografiaEletronico} className="btn btn-success">Monografia em meio eletronico</button>
