            ...
            <div className="mono">
              <fieldset>
                <FormGroup
                  ...
                  htmlFor="exampleInputSubArtigo"
                >
                  <input
                    type="SubtituloArtigo*"
                    onChange={(e) =>
                      this.setState({ subtituloArtigo: e.target.value })
                    }
                    className="form-control"
                    id="exampleInputTitulo1"
                    aria-describedby="tituloHelp"
                    placeholder="Ex: A história de um calvo"
                  />
                </FormGroup>

                <FormGroup
                  label="Titulo periodico "
                ...
                <FormGroup label="DOI " htmlFor="exampleInputEditora1">
                  <input
                    type="Editora*"
                ...
                <FormGroup label="URL " htmlFor="exampleInputEditora1">
                  <input
                    type="Editora*"
                    onChange={(e) => this.setState({ editora: e.target.value })}
                    className="form-control"
