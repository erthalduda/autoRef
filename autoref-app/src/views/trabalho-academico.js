                    ...
                    <div className="row">
                        ...
                        <div className="mono">
                            ...
                            <fieldset>
                                ...
                                <FormGroup label='Tipo de trabalho ' htmlFor="exampleInputAnol1">
                                    <input type='Ano de publicação*'
                                ...
                                <FormGroup label='Grau de formação ' htmlFor="exampleInputAnol1">
                                    <input type='Ano de publicação*'
                    ...
                    <div className="row">
                        ...
                        <div className="mono">
                            ...
                            <fieldset>
                                ...
                                <FormGroup label='Vinculação Academica ' htmlFor="exampleInputAnol1">
                                    <input type='Ano de publicação*'
