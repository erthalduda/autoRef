                            ...
                            <fieldset>
                                ...
                                <FormGroup label='Autor da parte ' htmlFor="autorParte">
                                    <input type='text'
                                        ...
                                        onChange={e => this.setState({ autorParte: e.target.value })} />
                                ...
                                <FormGroup label='Titulo da parte ' htmlFor="tituloParte">
                                    <input type='text'
                                        ...
                                        className="form-control"
                                        id="tituloParte"
                                        aria-describedby="tituloParteHelp" placeholder="Ex: A historia de um calvo"
                                        onChange={e => this.setState({ tituloParte: e.target.value })} />
                            ...
                            <fieldset>
                                ...
                                <FormGroup label='Capitulo ' htmlFor="capitulo">
                                    <input type='text'
                                        ...
                                        onChange={e => this.setState({ capitulo: e.target.value })} />
                                    ...
                                    {inputFields.map((input, index) => {
                                        return (
                                            <div key={index} style={{ marginBottom: '10px' }}>
                                                <input type='text' style={{ marginBottom: '23px' }}
