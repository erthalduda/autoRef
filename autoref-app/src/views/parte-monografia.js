                    ...
                    <div className="row">
                        ...
                        <div className="mono">
                            ...
                            <fieldset>
                                ...
                                <FormGroup label='Autor da parte ' htmlFor="exampleInputAutorParte">
                                    <input type='Autor da parte*'

                                        onChange={e => this.setState({ autor: e.target.value })}
                                        className="form-control"
                                        id="exampleInputAutorParte"
                                        aria-describedby="autorHelp" placeholder="Ex: Caio Ribeiro" />
                                ...
                                <FormGroup label='Titulo da parte ' htmlFor="exampleInputTitutloParte">
                                    <input type='TituloParte*'

                                        onChange={e => this.setState({ titulo: e.target.value })}
                                        className="form-control"
                                        id="exampleInputTitutloParte"
                                        aria-describedby="tituloParteHelp" placeholder="Ex: Coraline" />
                                ...
                                <FormGroup label='Ano de publicação ' htmlFor="exampleInputAnol1">
                                ...
                                <FormGroup label='Ano de entrega ' htmlFor="exampleInputAnoEntrega1">
                            ...
                            <fieldset>
                                ...
                                <FormGroup label='Volume ' htmlFor="exampleInputVolume1">
                                    <input type='Volume*'
                                        ...
                                        aria-describedby="emailHelp" placeholder="Ex: 3" />

                                </FormGroup>


                                <FormGroup label='Quantidade de paginas ' htmlFor="exampleInputQuantPg">
                                    <input type='Ano de entrega*'

                                        onChange={e => this.setState({ quantPg: e.target.value })}
                                        className="form-control"
                                        id="exampleInputQuantPg"
                                        aria-describedby="anoEntregaHelp" placeholder="Ex: 165" />
                                ...
                                <FormGroup label='Seção ' htmlFor="exampleInputSecao1">
                                    <input type='Secao*'
                                        ...
                                        aria-describedby="emailHelp" placeholder="Ex: Sla" />
                                ...
                                <FormGroup label='Capitulo ' htmlFor="exampleInputCapitulo1">
                                    <input type='Capitulo*'
                                        ...
                                        aria-describedby="capituloHelp" placeholder="Ex: 4" />
                                    ...
                                    {inputFields.map((input, index) => {
                                        return (
                                            <div key={index} style={{ marginBottom: '10px' }}>
                                                <input type='Autor*' style={{ marginBottom: '23px' }}
